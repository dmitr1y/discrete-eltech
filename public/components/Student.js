...
export default class Student extends Component {
    ...
    <
        img
        src = {this.state.student.photo
    }
        className = "photo" / >
            < div
        className = "info" >
            < div
        className = "name field" > {this.state.student.first_name
    }
        {
    ...
    <
        Link
        to = {'/group/' +this.state.student.group} > {this.state.student.group
    }<
        /Link>
        < /div>
        < div
        className = "email field" >
            < a
        href = {'mailto:' +this.state.student.email} > {this.state.student.email
    }<
        /a>
        < /div>
        {
        ...
        <
            ...
            className = "website field" >
                < a
            href = {this.state.student.website
        }
