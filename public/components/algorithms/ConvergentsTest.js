...
export default class ConvergentsTest extends Component {
    ...
    refreshExample() {
        fetch('https://edu.konstantinov.com.ru/app/evklid/test/convergents?id=' + getCookie('student_id'))
    ...
    render() {
        return (
            <div className="content-wrap">
                ...
                {this.state.input ?
                    <div>
                        <p> Найдите подходящиедроби для {this.state.input[0]}/{this.state.input[1]}</p>
                        <div className="table">
